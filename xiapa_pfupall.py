...
# mycursor.execute("SELECT proid,fa_wanlshop_wholesale.id FROM fa_wanlshop_wholesale INNER JOIN fa_wanlshop_wholesale_spu ON fa_wanlshop_wholesale.id = fa_wanlshop_wholesale_spu.goods_id WHERE fa_wanlshop_wholesale_spu.item = '')
mycursor.execute("SELECT proid,fa_wanlshop_wholesale.id FROM fa_wanlshop_wholesale INNER JOIN fa_wanlshop_wholesale_spu ON fa_wanlshop_wholesale.id = fa_wanlshop_wholesale_spu.goods_id WHERE  fa_wanlshop_wholesale_spu.name = '' ")
