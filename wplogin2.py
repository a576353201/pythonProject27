...
def get_captcha():
    #获取验证码图片所在的url
    r = session.get('https://uxren.cn/wp-login.php', headers=headers)
...
def isLogin():
    # 通过查看用户个人信息来判断是否已经登录
    url = "https://uxren.cn/yonghuxinxi"
...
def login(secret, account):
    ...
    postdata = {
        ...
        'log': secret,
        'rememberme': 'true',
        'redirect_to': 'https://uxren.cn/wp-admin ',
        'testcookie': 1,
        'wp-submit': '登录'
...
if __name__ == '__main__':
    ...
    headers = {
        "Host": "uxren.cn",
        "Origin": "https://uxren.cn",
        "Referer": "https://uxren.cn/wp-login.php",
        'User-Agent': agent,
